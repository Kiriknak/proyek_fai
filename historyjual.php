...
?>
    ...
    <body>
        ...
        <h1 class="ui header center aligned">Riwayat Penjualan</h1>
                ...
                <table class="ui celled table" id="tableku">
                    <thead>
                        <tr>
                            ...
                            <th id="tab">Tanggal </th>
                            <th id="tab">Id Barang</th>
                            <th id="tab">Jumlah </th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        $result = $conn->query("SELECT id_transaksi,id_barang,tanggal,jumlah ,harga   
                        from detail_transaksi join transaksi using(id_transaksi) natural join barang where id_seller='$username'");
